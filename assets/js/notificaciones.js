...
class SistemaNotificaciones {
    ...
    async registrarServiceWorker() {
        ...
        try {
            const swUrl = '/Pagina_Solicitudes2/sw.js';
            console.log('→ Registrando SW en:', swUrl);
            
            const registration = await navigator.serviceWorker.register(swUrl, {
                scope: '/Pagina_Solicitudes2/'
            });
    ...
    conectarSSE() {
        ...
        const sseUrl = '/Pagina_Solicitudes2/notificaciones/stream.php';
    ...
    async mostrarNotificacionEscritorio(notificacion) {
        ...
        try {
            const notification = new Notification(notificacion.titulo, {
                ...
                icon: '/Pagina_Solicitudes2/assets/img/notification-icon.png',
    ...
    async actualizarContador() {
        ...
        try {
            const response = await fetch('/Pagina_Solicitudes2/notificaciones/contar.php');
