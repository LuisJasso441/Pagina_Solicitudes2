        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo URL_BASE; ?>colaborativo/crear_documento.php">
            ...
            <div class="content-wrapper">
                ...
                <div class="alert alert-info d-flex align-items-center mb-4" role="alert">
                    ...
                    <div>
                        ...
                        Como parte de <?php echo htmlspecialchars($departamento); ?>, tienes acceso a documentos compartidos.
                    </div>
                </div>
                        ...
                        <div class="card card-custom">
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-wrap gap-3">
                                    ...
                                    <a href="<?php echo URL_BASE; ?>colaborativo/documentos.php" class="btn btn-outline-info">
                                        <i class="bi bi-folder-symlink"></i> Ver Documentos Compartidos
                                    </a>
                                </div>
                            </div>
                        </div>
